...
dart::dynamics::SkeletonPtr MobileKukaBase::MakeSkeleton() {
  const auto urdf_name = "/home/aorthey/git/FibrationTrees/data/robots/kuka_lwr/kuka_mobile_base_only.urdf";
