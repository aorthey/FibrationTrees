...
dart::dynamics::SkeletonPtr LiftTruckRobot::MakeSkeleton(const YAML::Node& node) {
  const auto urdf_name = GetDataFolder() + "robots/lifttruck.urdf";
  ...
  transform.translation() = State3d{0.0, 0.0, -0.15};
