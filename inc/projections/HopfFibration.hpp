...
class HopfFibration : public ompl::multilevel::FiberedProjection
{
 public:
  using ompl::multilevel::FiberedProjection::lift;

  HopfFibration(const ompl::base::SpaceInformationPtr& bundle, const ompl::base::SpaceInformationPtr& base);
  ~HopfFibration();
