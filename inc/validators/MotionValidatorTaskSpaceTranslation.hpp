...
class MotionValidatorTaskSpaceTranslation : public ompl::multilevel::TaskSpaceMotionValidator
{
 public:
  MotionValidatorTaskSpaceTranslation() = delete;
  explicit MotionValidatorTaskSpaceTranslation(const ompl::base::SpaceInformationPtr &si, const RobotPtr& robot);
  virtual ~MotionValidatorTaskSpaceTranslation() override;
