...
DOPTIONS="--remove-ylabel --no-title --linewidth 20 --only-success-graph --label-fontsize 60 --legend-none --fontsize 70 --planner-color geometric_RRT=${RRT} --planner-color geometric_FibrationRrt=${FIBRRT_DECOMP}"
...
###### 00 Multi Disks
###############################################################################
# python3 ${EXEC} ../data/logs/01_DisksInCrossing.db ${DOPTIONS} --min-time 0.01 --max-time 180
# python3 ${EXEC} ../data/logs/02_DisksOnSquare.db ${DOPTIONS} --min-time 0.01 --max-time 180
# python3 ${EXEC} ../data/logs/03_DisksInTee.db ${DOPTIONS} --min-time 0.01 --max-time 600
# python3 ${EXEC} ../data/logs/04_DisksInMaze.db ${DOPTIONS} --min-time 0.01 --max-time 600
